...
import { FloatPopUp } from "../floatButton/floatPopUp";
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          minHeight: `calc(${innerHeight ? `${innerHeight}px` : "100vh"} - ${
            listTabBar && listTabBar.length > 0
              ? "calc(5.75rem + 1px)"
              : appBarTitle === undefined || appBarTitle === ""
              ? "4rem"
      ...
      {hasBottomTabBar && <BottomTabBar activeIndex={bottomTabBarIndex || 0} />}
    </>
  );
};
