				...
				<div className="column is-6 is-offset-3 has-text-centered">
					<div className="block mb-1">
						...
						<h1 className={styles.title}>
							Welcome to your Client List
						</h1>
						<p>
							New leads from Facebook, your website, and other
							integrations will appear here, alongside any
							contacts added via your mobile app.
						</p>
					</div>
				</div>
			)}
